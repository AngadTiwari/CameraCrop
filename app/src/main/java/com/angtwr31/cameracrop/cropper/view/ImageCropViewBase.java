...
package com.angtwr31.cameracrop.cropper.view;
...
import com.angtwr31.cameracrop.cropper.easing.Cubic;
import com.angtwr31.cameracrop.cropper.easing.Easing;
import com.angtwr31.cameracrop.cropper.model.CropInfo;
import com.angtwr31.cameracrop.cropper.util.BitmapLoadUtils;
import com.angtwr31.cameracrop.cropper.view.graphics.FastBitmapDrawable;
...
public abstract class ImageCropViewBase extends ImageView {
    ...
    public void setImageFilePath(Activity activity, String imageFilePath){
        File imageFile = new File(imageFilePath);
        if (!imageFile.exists()) {
            //throw new IllegalArgumentException("Image file does not exist");
            Toast.makeText(activity, "Image does not exist", Toast.LENGTH_SHORT).show();
            activity.finish();
        }
